...
→ активний стан, прогрес, ключовий CTA 

● **Warm graphite / нейтралі** 

→ фони, контейнери, текст 
...
● ❌ позначати статус **тільки кольором** (завжди \+ текст / іконка) **PRIMARY PALETTE (Основні бренд-кольори) Brand retro yellow** 

● **Hex:** \#FAB62C 

● **Використання:** Progress bars, accent borders, hover states на модулях ● **НЕ використовувати для:** Primary buttons 
...
● **Використання:** Альтернатива для темних елементів, дуже темний текст ● **НЕ є основним кольором buttons** 
...
● **Використання:** Hover borders на модулях, active state indicators **Accent deep orange** 
...
**Назва Hex Використання Void** \#333552 Основний текст, іконки **Midnight Slate** \#4B4E63 Підзаголовки **Twilight Charcoal** \#6B6E85 Secondary text **Dusk Gray** \#898CA8 Placeholder text **Steel** \#A7AACA Disabled text **Slate** \#C5C7DB Borders 

**Stone** \#DCDFE9 Secondary backgrounds **Haze** \#E9EBF3 Card backgrounds **Cloud** \#F5F6FA Main background **Mist** \#FAFBFD Lightest background  
...
● **Body 2:** Montserrat 14px Regular, line-height 150% — **основний текст на картках** ● **Caption:** Montserrat 12px Regular, line-height 140% — **timestamps, підписи** 
...
**spacing-md** 16px **DEFAULT** — між елементами **spacing-lg** 24px Card padding, між групами **spacing-xl** 32px Між секціями 
...
● **Shadow:** Soft shadow (0 2px 8px rgba(0,0,0,0.08)) ● **Icon:** 32px, колір \#333552 (Navy) 
...
● **Hover:** Помаранчева обводка \#F47E2A, 2px ● **Active:** Помаранчева обводка \+ помаранчевий текст 
...
2\. **Subtitle:** Montserrat 14px Regular, \#6B6E85 (сірий) 3\. **Price:** Montserrat 14px SemiBold, \#333552 4\. **Company:** Montserrat 14px Regular, \#898CA8 5\. **Badges:** 8px padding, 16px border-radius 
...
● **Помаранчевий** \#FFB74D: "Сервіс", "Консультація" ● **Блакитний** \#4FC3F7: "Тренінг" 
...
4\. **Timestamp:** Montserrat 12px Regular, \#898CA8 5\. **Status change:** Arrow → "New", зелений background 6\. **Buttons:** Small size (32px height) 
...
❗ 14\. ВАЖЛИВІ ПРАВИЛА **НЕ РОБИТИ:** 

❌ Не використовуй Brand Yellow (\#FAB62C) для PRIMARY buttons ❌ Не використовуй Accent Orange для SECONDARY buttons ❌ Не міксуй кольори badges (строго по таблиці) 
